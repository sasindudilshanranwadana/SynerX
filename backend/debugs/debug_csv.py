...
def test_csv_backup():
    ...
    existing_data = DataManager.read_existing_data()
    ...
    try:
        result = DataManager.update_tracking_file(mock_history)
...
def test_csv_append_scenario():
    ...
    DataManager.update_tracking_file(initial_history)
    ...
    DataManager.update_tracking_file(updated_history)
