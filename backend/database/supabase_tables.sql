...
/*
 ...
 INSERT INTO tracking_results (tracker_id, vehicle_type, status, compliance, reaction_time, weather_condition, temperature, humidity, visibility, precipitation_type, wind_speed, date) VALUES
 (1, 'car', 'stationary', 1, 2.5, 'clear', 22.5, 65, 10.0, 'none', 5.2, NOW()),
 (2, 'truck', 'moving', 0, NULL, 'rainy', 18.0, 85, 6.5, 'rain', 12.8, NOW()),
 (3, 'car', 'stationary', 1, 1.8, 'cloudy', 20.0, 70, 8.0, 'none', 8.5, NOW());
...
WHERE table_schema = 'public'
    AND table_name IN ('tracking_results', 'vehicle_counts');
