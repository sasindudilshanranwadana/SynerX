...
const mockTrackingData: TrackingResult[] = [
  { tracker_id: 1, video_id: 101, vehicle_type: 'car', compliance: 1, reaction_time: 1.5, weather_condition: 'clear', date: new Date().toISOString(), status: 'moving', temperature: 20 },
  { tracker_id: 2, video_id: 102, vehicle_type: 'truck', compliance: 0, reaction_time: undefined, weather_condition: 'rainy', date: new Date().toISOString(), status: 'moving', temperature: 15 },
  { tracker_id: 3, video_id: 103, vehicle_type: 'car', compliance: 1, reaction_time: 2.0, weather_condition: 'clear', date: new Date(Date.now() - 8 * 24 * 60 * 60 * 1000).toISOString(), status: 'stationary', temperature: 22 },
];
